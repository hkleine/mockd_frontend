...
function Dashboard() {
  ...
  return (
    <div>
      {isAuthenticated && (
        <div class="fixed z-30 inset-y-0 left-0 w-64 h-screen transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
